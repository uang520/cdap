...
public class Authorizable {
  ...
  public static Authorizable fromEntityId(EntityId entityId) {
    ...
    if (entityId.getEntityType().equals(EntityType.ARTIFACT) || entityId.getEntityType().equals(EntityType.APPLICATION)) {
      System.out.println("###" + entity);
      int endIndex = entity.lastIndexOf(EntityId.IDSTRING_PART_SEPARATOR);
