...
public class MapReduceStageStatisticsCollector implements StageStatisticsCollector {
  private static final String STAT_GROUP_NAME = "stage.statistics";
  ...
  public void incrementInputRecordCount() {
    context.getCounter(STAT_GROUP_NAME, inputRecordCountKey).increment(1);
  }

  @Override
  public void incrementOutputRecordCount() {
    context.getCounter(STAT_GROUP_NAME, outputRecordCountKey).increment(1);
  }

  @Override
  public void incrementErrorRecordCount() {
    context.getCounter(STAT_GROUP_NAME, errorRecordCountKey).increment(1);
  }
}
